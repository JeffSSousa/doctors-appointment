...
import com.jeffersonssousa.doctorsappointment.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public SecurityFilterChain authServerSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 1. Registra os endpoints do Authorization Server
        OAuth2AuthorizationServerConfigurer authorizationServerConfigurer =
                new OAuth2AuthorizationServerConfigurer();

        http
                .securityMatcher(authorizationServerConfigurer.getEndpointsMatcher()) // garante que só afete os endpoints do Authorization Server
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()
                ...
                // Refresh token é o token para renovar o access token
            ...
            if (principal instanceof CustomAuthentication authentication){
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tipoToken)){
                    ...
                    context
                            ...
                            .claim("email", authentication.getLogin().getEmail());
